  ...
  return (
    <div className='navbar'>
      ...
      <ul className='navauth'>
        {login ?
          <div className='admin' style={{display: 'flex', gap: '10px'}}>
            <button className="dropbtn" type='button'><Link to="/admin" style={{color: '#fff', textDecoration: 'none'}}>Admin</Link></button>
